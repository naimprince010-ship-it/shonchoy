        ...
        {activeTab === 'daily' && (
          <div className="flex items-center space-x-2">
            ...
            <input 
              ...
              className="border border-slate-300 rounded-md py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white"
            />
          </div>
        )}
      </div>
        ...
        <div>
          ...
          {portfolioLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg shadow p-6 border-b-4 border-indigo-500">
                <dt className="text-sm font-medium text-slate-500 truncate">Total Disbursed Amount</dt>
                <dd className="mt-2 text-3xl font-semibold text-indigo-600">৳{portfolioData.disbursed_loans_amount}</dd>
              </div>
              ...
              <div className="bg-white rounded-lg shadow p-6 border-b-4 border-blue-500">
                ...
                <dd className="mt-2 text-3xl font-semibold text-blue-600">৳{portfolioData.total_outstanding}</dd>
              ...
              <div className={`bg-white rounded-lg shadow p-6 border-b-4 ${portfolioData.par_percentage > 5 ? 'border-red-500' : 'border-yellow-500'}`}>
        ...
        <div>
          ...
          {dailyLoading ? (
            <div className="animate-pulse space-y-4">
              <div className="h-16 bg-slate-200 rounded-lg w-1/3 mb-6"></div>
              <div className="h-64 bg-slate-200 rounded-lg"></div>
            </div>
          ) : dailyData && (
            <div className="space-y-6">
              {/* Daily Summary */}
              <div className="bg-white rounded-lg shadow p-6 inline-block border-l-4 border-emerald-500">
